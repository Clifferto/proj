...
src/%.o: ../src/%.c
	...
	mb-gcc -Wall -O0 -g3 -c -fmessage-length=0 -MT"$@" -I/media/cliff/procom/verilog/microBase/microBase.vitis/hwBlk_wrapper/export/hwBlk_wrapper/sw/hwBlk_wrapper/standalone_domain/bspinclude/include -mlittle-endian -mcpu=v11.0 -mxl-soft-mul -Wl,--no-relax -ffunction-sections -fdata-sections -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@)" -o "$@" "$<"
