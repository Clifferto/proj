...
HD_PWD='/home/becario/ethernet/microBase/microBase.runs/hwBlk_microblaze_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hwBlk_microblaze_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hwBlk_microblaze_0_0.tcl
