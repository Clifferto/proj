...
HD_PWD='/home/becario/ethernet/proj/microBase/microBase.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log hwBlk_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source hwBlk_wrapper.tcl -notrace
