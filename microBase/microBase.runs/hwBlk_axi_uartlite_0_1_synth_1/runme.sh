...
HD_PWD='/home/becario/ethernet/proj/microBase/microBase.runs/hwBlk_axi_uartlite_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hwBlk_axi_uartlite_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hwBlk_axi_uartlite_0_1.tcl
