...
HD_PWD='/home/becario/ethernet/microBase/microBase.runs/hwBlk_ilmb_bram_if_cntlr_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hwBlk_ilmb_bram_if_cntlr_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hwBlk_ilmb_bram_if_cntlr_1.tcl
