...
HD_PWD='/home/becario/ethernet/proj/microBase/microBase.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hwBlk_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hwBlk_wrapper.tcl
