...
HD_PWD='/home/becario/ethernet/proj/noSeasCulia/noSeasCulia.runs/blkEth_mdm_1_6_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log blkEth_mdm_1_6.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source blkEth_mdm_1_6.tcl
