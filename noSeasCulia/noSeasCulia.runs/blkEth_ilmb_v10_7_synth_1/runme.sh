...
HD_PWD='/home/becario/ethernet/proj/noSeasCulia/noSeasCulia.runs/blkEth_ilmb_v10_7_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log blkEth_ilmb_v10_7.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source blkEth_ilmb_v10_7.tcl
