...
HD_PWD='/home/becario/ethernet/proj/noSeasCulia/noSeasCulia.runs/eth0_microblaze_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log eth0_microblaze_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source eth0_microblaze_0_0.tcl
