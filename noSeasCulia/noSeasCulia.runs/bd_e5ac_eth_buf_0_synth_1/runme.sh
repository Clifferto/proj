...
HD_PWD='/home/becario/ethernet/proj/noSeasCulia/noSeasCulia.runs/bd_e5ac_eth_buf_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bd_e5ac_eth_buf_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bd_e5ac_eth_buf_0.tcl
