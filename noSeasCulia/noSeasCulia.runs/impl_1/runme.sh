...
HD_PWD='/home/becario/ethernet/proj/noSeasCulia/noSeasCulia.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log blkEth_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source blkEth_wrapper.tcl -notrace
