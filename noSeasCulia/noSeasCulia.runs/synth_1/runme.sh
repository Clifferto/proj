...
HD_PWD='/home/becario/ethernet/proj/noSeasCulia/noSeasCulia.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log blkEth_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source blkEth_wrapper.tcl
