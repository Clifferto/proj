...
HD_PWD='/home/becario/ethernet/proj/noSeasCulia/noSeasCulia.runs/blkEth_mig_7series_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log blkEth_mig_7series_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source blkEth_mig_7series_0_2.tcl
