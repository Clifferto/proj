...
HD_PWD='/home/becario/ethernet/proj/noSeasCulia/noSeasCulia.runs/blkEth_axi_intc_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log blkEth_axi_intc_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source blkEth_axi_intc_0_0.tcl
