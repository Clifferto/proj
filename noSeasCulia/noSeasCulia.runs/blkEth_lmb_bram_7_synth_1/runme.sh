...
HD_PWD='/home/becario/ethernet/proj/noSeasCulia/noSeasCulia.runs/blkEth_lmb_bram_7_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log blkEth_lmb_bram_7.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source blkEth_lmb_bram_7.tcl
