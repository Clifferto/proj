...
HD_PWD='/home/becario/ethernet/proj/noSeasCulia/noSeasCulia.runs/eth0_axi_ethernet_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log eth0_axi_ethernet_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source eth0_axi_ethernet_0_1.tcl
