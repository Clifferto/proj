...
HD_PWD='/home/becario/ethernet/proj/noSeasCulia/noSeasCulia.runs/blkEth_microblaze_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log blkEth_microblaze_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source blkEth_microblaze_0_0.tcl
